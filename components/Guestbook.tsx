...
function GuestbookEntry({ entry, user }) {
  ...
  return (
    <div className="flex flex-col space-y-2">
      <div className="prose w-full break-words dark:prose-dark">{entry.body}</div>
...
export default function Guestbook({ fallbackData }) {
  ...
  return (
    <>
      <div className="my-4 w-full rounded border border-blue-200 p-6 text-black  dark:border-gray-800 dark:text-white">
